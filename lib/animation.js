...
function animateFov() {
  ...
  setTimeout(() => clearInterval( fovDecrementInterval ), 12500);
}

function animateFovTo0() {
  fovDecrementInterval = setInterval( decrementFovTo0, 7 );
  setTimeout(() => clearInterval( fovDecrementInterval ), 2500);
}
